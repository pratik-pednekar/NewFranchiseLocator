...
def app():
    ...
    st.title('BubbleTea location')

    st.write("Based on the ML algorithm and the location of the existing franchises we predict the location of bubble tea")
    st.write("places in New York")

    st.markdown("### Sample Data")


    st.write('Navigate to `Results` page to visualize the data')
